                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  // SizedBox(width: 56, height: 56, child: IconButton(icon: SvgPicture.asset('lib/images/video_camera.svg'), onPressed: () {})),
                                  SizedBox(width: 66, height: 66, child: IconButton(icon: SvgPicture.asset('lib/images/arrow_left.svg'), onPressed: () {})),
                                  SizedBox(width: 66, height: 66, child: IconButton(icon: SvgPicture.asset('lib/images/flip.svg'), onPressed: () {})),
                                  SizedBox(width: 66, height: 66, child: IconButton(icon: SvgPicture.asset('lib/images/endcall.svg'), onPressed: () {})),
                                  SizedBox(width: 66, height: 66, child: IconButton(icon: SvgPicture.asset('lib/images/mic.svg'), onPressed: () {})),
                                  SizedBox(width: 66, height: 66, child: IconButton(icon: SvgPicture.asset('lib/images/video_camera.svg'), onPressed: () {})),
                                ],
                              ),
                            ),
                          ),
  ...
  Widget customAppBar() => CustomAppBar(
        ...
        title: Column(
          children: <Widget>[
            ...
            Text('01:05:23', style: TextStyle(color: Colors.white, fontSize: 14)),
          ],
        ),
        actions: <Widget>[
